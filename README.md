...
Этот аналитический проект был выполнен для крупного сервиса проката самокатов GoFast с целью анализа поведения пользователей и оценки эффективности платной подписки. В ходе исследования были обработаны и проанализированы данные о пользователях, их поездках и подписках.

Что сделано:
1. Предварительная обработка данных:
   - Очистка от дубликатов и пропусков
   - Преобразование типов данных
   - Объединение таблиц для комплексного анализа

2. Исследовательский анализ данных (EDA):
   - Анализ демографии пользователей
   - Исследование распределения длительности и дистанции поездок
   - Сравнение поведения пользователей с подпиской и без

3. Статистический анализ:
   - Проверка гипотез о различиях в поведении пользователей
   - Расчет вероятностей с использованием нормального распределения
   - Определение критических значений для бизнес-решений

4. Финансовый анализ:
   - Расчет месячной выручки на пользователя
   - Сравнение доходности разных типов подписок

## Основные результаты и выводы

### Для бизнеса:
- Пользователи с подпиской Ultra:
  - Совершают более длительные поездки (в среднем 19 мин против 17 мин у Free)
  - Приносят большую выручку (359 руб/мес против 322 руб/мес у Free)
  - Статистически подтверждено, что их средняя выручка значимо выше

- Распределение поездок:
  - Только 2% поездок длятся более 30 минут
  - 37.7% поездок попадают в интервал 20-30 минут - потенциальная целевая группа для промоакций

- Критическая дистанция:
  - 90% поездок имеют дистанцию менее 4502 метров
  - Это значение можно использовать для введения дополнительных тарифов

### Технические достижения:
- Реализован комплексный анализ данных от очистки до визуализации
- Применены продвинутые статистические методы (t-тесты, нормальное распределение)
- Разработаны автоматизированные расчеты выручки
- Созданы информативные визуализации для представления результатов
...
Проект демонстрирует способность превращать сырые данные в ценные бизнес-инсайты, что делает меня ценным аналитиком для компаний в сфере мобильности и шеринговых сервисов.

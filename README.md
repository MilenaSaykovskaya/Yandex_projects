...
Цель проекта: помочь агентству недвижимости из Петрозаводска выйти на рынок Санкт-Петербурга и Ленинградской области, определив:  
- Наиболее перспективные сегменты недвижимости.  
- Сезонные тенденции спроса и предложения.  
- Самые активные населенные пункты Ленобласти.  

Что сделано:
1. Предобработка данных:  
   - Удалены аномалии (выбросы по 99 перцентилю, нереальные значения).  
2. Ad hoc-анализ:  
   - Определены сегменты с самым быстрым и медленным временем продажи.  
   - Проанализированы факторы, влияющие на активность объявлений (цена, площадь, этажность).  
   - Выявлены сезонные колебания спроса и цен.  
   - Определены топ-населенные пункты Ленобласти по активности продаж.  
3. Визуализация:  
   - Доработан дашборд в DataLens для наглядного представления данных.  

Результаты и выводы:
- СПб vs Ленобласть:  
  - В СПб дорогая недвижимость (от 115 тыс./м²) продается дольше, в Ленобласти — быстрее (от 68 тыс./м²).  
  - В СПб популярны квартиры площадью ~66 м², в Ленобласти — ~49–55 м².  
- Сезонность:  
  - Пик публикаций — февраль–апрель, пик продаж — апрель и ноябрь.  
  - Самые высокие цены — в ноябре, самые низкие — в июле–августе.  
- Топ-города Ленобласти:  
  - Наибольшая активность — Мурино, Кудрово, Шушары.  
  - Быстрее всего продается в Колпино (147 дней), медленнее — в Сестрорецке (215 дней).  
...
Анализ помогает 
- Снизить риски при выходе на новый рынок.  
- Оптимизировать рекламные бюджеты с учетом сезонности.  
- Выбрать правильные локации и сегменты для максимальной прибыли.  

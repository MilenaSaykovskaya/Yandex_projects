...
- [Кейсы](#-кейсы-с-измеримым-результатом)
  - **Python & SQL & DataLens**
    - [Afisha User Behavior](#-1-анализ-пользователей-afisha-2024) — Анализ сезонных колебаний и пользовательской активности
  - **SQL & DataLens**
    - [DonorSearch](#%EF%B8%8F-2-анализ-донорской-активности-для-donorsearch) — Геоанализ и эффективность донорских программ
    - [Real Estate](#-4-анализ-ранка-недвижимости) — Аналитика рынка недвижимости СПб/ЛО
  - **Python**

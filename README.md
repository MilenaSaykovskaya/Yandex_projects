...
- [Кейсы](#-кейсы-с-измеримым-результатом)
  - [Анализ пользователей Afisha](#-1-анализ-пользователей-afisha-2024)
  - [Анализ донорской активности](#-2-анализ-донорской-активности-для-donorsearch)
  - [Анализ сервиса проката самокатов](#-3-аналитический-проект-для-сервиса-проката-самокатов)
  - [Анализ рынка недвижимости](#-4-анализ-ранка-недвижимости)
